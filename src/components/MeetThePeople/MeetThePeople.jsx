          ...
          <Carousel.Item>
            <div className="d-flex justify-content-center">
              <Card className="meet-people-card">
                <Card.Body>
                  <h3>Java Full Stack Bootcamp</h3>I heard about Lejhro from a
                  friend and enrolled in its Full stack Development Bootcamp,
                  what followed was an immersive learning experience that helped
